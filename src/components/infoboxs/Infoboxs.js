  ...
  return (
    <div className='infoboxs'>
      ...
      <div className='box b2'>
        ...
        <p>
          By promoting safety and environmental awareness in daily activities
          and assigning responsibility for all aspects of the company. Through
          QHSE policy, we successfully manage to ensure overall safe performance
      ...
      <div className='box b3'>
        ...
        <p>
          To build stronger, enhanced, and safer structures in a process that
